...
class AdminController {
  ...
  static async getOfficeCalendar(req, res, next) {
    const officeCalendar = await AdminServices.serviceGetCalendarOffice(
      req,
      next
    );
  ...
  static async getOfficeCalendarSecurity(req, res, next) {
    const securityCalendar = await AdminServices.serviceGetCalenderSecurity(
      req,
      next
    );
  ...
  static async getSecuritiesByDistance(req, res, next) {
    const { y, x } = req.body;
    const securities = await AdminServices.serviceGetSecuritiesByDistance(
      req,
      next
    );
